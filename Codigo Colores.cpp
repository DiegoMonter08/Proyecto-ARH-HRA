...
void registrarAsistencia() {
    ...
    if (indice < 1 || indice > empleados.size()) {
        cout << "\033[1;33mEmpleado no encontrado.\033[0m" << endl;
        return;
    }
...
void mostrarAsistencia() {
    ...
    cin >> indice;
    if (indice < 1 || indice > empleados.size()) {
        cout << "\033[1;34mEmpleado no encontrado.\033[0m" << endl;
        return;
    }
...
void registrarInasistencia() {
    ...
    cin >> indice;
    if (indice < 1 || indice > empleados.size()) {
        cout << "\033[1;35mEmpleado no encontrado.\033[0m" << endl;
        return;
    }
...
void actualizarEmpleado() {
    ...
    cin >> indice;
    if (indice < 1 || indice > empleados.size()) {
        cout << "\033[1;37mEmpleado no encontrado.\033[0m" << endl;
        return;
    }
...
void eliminarEmpleado() {
    ...
    cin >> indice;
    if (indice < 1 || indice > empleados.size()) {
        cout << "\033[1;38mEmpleado no encontrado.\033[0m" << endl;
        return;
    }
